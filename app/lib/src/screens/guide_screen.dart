      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            _section(
              icon: GameIcons.unique,
              title: 'Character Perks',
              children: [
                const Padding(
                  padding: EdgeInsets.only(bottom: 8),
                  child: Text(
                    'Every character has one innate perk, always active '
                    'regardless of Loadout, that combines with whatever you '
                    'equip. Nothing in the engine special-cases a perk by '
                    'name, they\'re just data read by the same generic rules '
                    'as everything else.',
                    style: TextStyle(color: Colors.white70, fontSize: 12),
                  ),
                ),
                for (final c in roster.all)
                  _GuideEntry(
                    ...
                    body:
                        '${c.perk?.name ?? 'No perk'}. ${c.perk?.description ?? ''}',
                  ),
              ],
            ),
            _section(
              ...
              children: [
                const Padding(
                  padding: EdgeInsets.only(bottom: 8),
                  child: Text(
                    '50 status effects, all expressed as data against the '
                    'same generic definition. Duration is in turns, ticked '
                    'down at the start of the affected character\'s team\'s '
            ...
            _section(
              ...
              children: [
                const Padding(
                  padding: EdgeInsets.only(bottom: 8),
                  child: Text(
                    '40 regular Triggers (active and passive) plus 10 Black '
                    'Triggers form the shared draft pool, any character may '
                    'equip any of them regardless of their own type. "Avg" '
                    'damage/heal figures are the expected value of the dice '
                    'before Armor/resistances/Team Spirit/perk modifiers are '
                    'applied.',
                    style: TextStyle(color: Colors.white70, fontSize: 12),
                  ),
                ),
                ...
                const Padding(
                  padding: EdgeInsets.only(bottom: 8),
                  child: Text(
                    'Each character may equip at most one. A Black Trigger '
                    'can carry active abilities (count toward the Loadout\'s '
                    'required 4), passive abilities (always on), and/or a '
                    'World ability (a battle-wide effect, distinct from a '
                    'passive stat bonus).',
                    style: TextStyle(color: Colors.white70, fontSize: 12),
                  ),
                ),
