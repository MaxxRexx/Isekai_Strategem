...
enum AiTargetPriority {
  ...
  /// Target whoever has the highest Attack stat - a proxy for "biggest
  /// threat" (The Grudge Holder).
  highestThreat,
...
class AiProfile {
  ...
  /// inflicting/heal-granting, see `LoadoutBuilder`).
  ...
  static const theCopycat = AiProfile(
    ...
    description: 'No real target discipline - picks whatever is in front '
        'of it rather than reading the board.',
    skillClass: AiSkillClass.beginner,
