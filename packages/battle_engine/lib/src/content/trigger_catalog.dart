...
/// The built-in 70-Trigger catalog (58 active, 12 passive), a shared draft
/// pool any character may equip regardless of their own [CharacterType] -
/// nothing in the [Loadout] rules restricts equipping by type. The active
/// set includes the 17 Unique-subtype Triggers (5 melee, 2 ranged, 10
/// psychic) that wire the Phase C unique behaviors to equippable Triggers.
