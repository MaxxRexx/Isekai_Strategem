      ...
      BlackTrigger(
        ...
        activeAbilities: [
          ActiveTrigger(
            ...
            damage: const DiceExpression(2, 8, flatBonus: 6),
          ),
          ActiveTrigger(
            ...
            attackSubtype: AttackSubtype.single,
            damageType: DamageType.fire,
            damage: const DiceExpression(2, 10, flatBonus: 4),
          ),
        ],
      ),
      BlackTrigger(
        ...
        activeAbilities: [
          ActiveTrigger(
            ...
            damage: const DiceExpression(1, 6, flatBonus: 3),
          ),
        ],
      ...
      BlackTrigger(
        ...
        activeAbilities: [
          ActiveTrigger(
            ...
            damage: const DiceExpression(3, 10, flatBonus: 10),
          ),
        ],
        passiveAbilities: const [
          BlackTriggerPassiveAbility(
      ...
      BlackTrigger(
        ...
        activeAbilities: [
          ActiveTrigger(
            ...
            healAmount: const DiceExpression(3, 6, flatBonus: 6),
          ),
          ActiveTrigger(
            id: 'wellspring_regen',
      ...
      BlackTrigger(
        ...
        activeAbilities: [
          ActiveTrigger(
            ...
            damage: const DiceExpression(1, 6, flatBonus: 2),
            inflictedStatusEffects: const [
          ...
          ActiveTrigger(
            ...
            damageType: DamageType.psychic,
            damage: const DiceExpression(2, 8, flatBonus: 4),
          ),
        ],
      ),
      BlackTrigger(
        ...
        description:
            ...
            'have reduced health to 0, landing on 1 instead.',
